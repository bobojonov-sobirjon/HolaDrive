...
from .views import (
    ...
    ScheduledOrderListView,
    OrderScheduleUpdateView,
...
urlpatterns = [
    ...
    path('scheduled/', ScheduledOrderListView.as_view(), name='order-scheduled-list'),
    ...
    path('<int:order_id>/schedule/', OrderScheduleUpdateView.as_view(), name='order-schedule-update'),
    path('<int:order_id>/stops/', OrderStopsUpdateView.as_view(), name='order-stops-update'),
